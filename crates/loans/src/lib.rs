...
impl<T: Config> OnDeposit<T::AccountId, AssetIdOf<T>, BalanceOf<T>> for DepositPreHook<T> {
...
impl<T: Config> OnDeposit<T::AccountId, AssetIdOf<T>, BalanceOf<T>> for DepositPostHook<T> {
...
impl<T: Config> OnTransfer<T::AccountId, AssetIdOf<T>, BalanceOf<T>> for TransferPreHook<T> {
    fn on_transfer(
...
impl<T: Config> OnTransfer<T::AccountId, AssetIdOf<T>, BalanceOf<T>> for TransferPostHook<T> {
    fn on_transfer(
        currency_id: AssetIdOf<T>,
        _from: &T::AccountId,
        to: &T::AccountId,
